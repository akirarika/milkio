...
function asciis() {
  return [
    ...
    ` ${chalk.hex("00AEF4")(`|`)} ${chalk.hex("00AEEA")(`|`)}${chalk.hex("00AEE0")(`\\`)}${chalk.hex("00AED6")(`/`)}${chalk.hex("00AECC")(`|`)} ${chalk.hex("00AEC1")(`|`)} ${chalk.hex("00AEB7")(`|`)} ${chalk.hex("00AEAD")(`|`)} ${chalk.hex("00AEA3")(`|`)}${chalk.hex("00AE99")(`/`)} ${chalk.hex("00AE8E")(
      `/`,
    )} ${chalk.hex("00AE84")(`|`)}${chalk.hex("00AE7A")(`/`)} ${chalk.hex("00AE70")(`_`)} ${chalk.hex("00AE66")(`\\`)}`,
