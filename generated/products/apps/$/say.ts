...
export const validateResults = async (results: any) => { _validate(((input: any): typia.IValidation<TSONEncode<ExecuteResultSuccess<ResultsT> | ExecuteResultFail>> => {
    ...
    const __is = (input: any): input is TSONEncode<ExecuteResultSuccess<ResultsT> | ExecuteResultFail> => {
        ...
        const $io4 = (input: any): boolean => Array.isArray(input.commands) && input.commands.every((elem: any) => "string" === typeof elem) && ("object" === typeof input.options && null !== input.options && false === Array.isArray(input.options) && $io5(input.options));
    ...
    if (false === __is(input)) {
        ...
        ((input: any, _path: string, _exceptionable: boolean = true): input is TSONEncode<ExecuteResultSuccess<ResultsT> | ExecuteResultFail> => {
            ...
            const $vo3 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.executeId || $report(_exceptionable, {
                    ...
                    path: _path + ".data",
                    expected: "RecursiveObjectXToString<__type, bigint | RegExp | URL | Date | Uint8Array | ArrayBuffer>",
                    value: input.data
            ...
            const $vo4 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [(Array.isArray(input.commands) || $report(_exceptionable, {
                    path: _path + ".commands",
                    expected: "Array<string>",
                    value: input.commands
                })) && input.commands.map((elem: any, _index1: number) => "string" === typeof elem || $report(_exceptionable, {
                    ...
                    path: _path + ".options",
                    expected: "RecursiveObjectXToString<Record<string, string | true>, bigint | RegExp | URL | Date | Uint8Array | ArrayBuffer>",
                    value: input.options
                })) && $vo5(input.options, _path + ".options", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".options",
                    expected: "RecursiveObjectXToString<Record<string, string | true>, bigint | RegExp | URL | Date | Uint8Array | ArrayBuffer>",
                    value: input.options
                })].every((flag: boolean) => flag);
            ...
            const $vu0 = (input: any, _path: string, _exceptionable: boolean = true): any => (() => {
                if (false === input.success)
                    ...
                    return $report(_exceptionable, {
                        path: _path,
                        expected: "(RecursiveObjectXToString<ExecuteResultFail, bigint | RegExp | URL | Date | Uint8Array | ArrayBuffer> | RecursiveObjectXToString<ExecuteResultSuccess<__type>, bigint | RegExp | URL | Date | Uint8Array | ArrayBuffer>)",
                        value: input
                    });
            })();
            return ("object" === typeof input && null !== input || $report(true, {
    ...
    const $so3 = (input: any): any => `{"executeId":${$string(input.executeId)},"success":${input.success},"data":${$so4(input.data)}}`;
    const $so4 = (input: any): any => `{"commands":${`[${input.commands.map((elem: any) => $string(elem)).join(",")}]`},"options":${$so5(input.options)}}`;
