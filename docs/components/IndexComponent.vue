...
.index(v-show="loaded")
  i.ri-anchor-line.index-logo
  .welcome
    img(src="./assets/kurimu.png" @load="loadCounter++")
    .welcome-title
      transition(name="fade" mode="out-in")
        .welcome-title--text1(v-if="0 === i % 4")
          | {{ text("足够简单的，") }}
        .welcome-title--text1(v-else-if="1 === i % 4")
          | {{ text("渐进式的，") }}
        .welcome-title--text1(v-else-if="2 === i % 4")
          | {{ text("驱动化的，") }}
        .welcome-title--text1(v-else-if="3 === i % 4")
          | {{ text("框架无关的，") }}
      .welcome-title--text2
      ...
      .welcome-button-group
        .welcome-button--docs(@click="toDocs")
          i.ri-anchor-line
          span {{ text("阅读文档") }}
        .welcome-button--github(@click="toGithub")
          i.ri-github-fill
          .welcome-button--github-corner
            img(src="https://img.shields.io/github/stars/akirarika/kurimudb?color=%2300000000&label=%20&style=for-the-badge")
  .index-markdown
    slot
</template>
