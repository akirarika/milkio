...
export type ExecuteResult<Path extends keyof ApiSchema["apiMethodsTypeSchema"]> = { success: true; data: Awaited<ReturnType<ApiSchema["apiMethodsTypeSchema"][Path]["api"]["action"]>>; } | { success: false; fail: Fail<keyof typeof failCode>; };